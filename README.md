This is a simple tip calculator where you can enter the amount and then select how much tip you want to give in percentage and the calculator will calculate the total amount paybel.
